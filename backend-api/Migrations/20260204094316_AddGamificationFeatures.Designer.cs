...
namespace PentestHub.API.Migrations
{
    ...
    [Migration("20260204094316_AddGamificationFeatures")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PentestHub.API.Data.Models.Badge", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IconUrl = "/badges/gold.png",
                            Name = "Gold Badge",
                            PointsRequired = 1000
                        });
                });

            modelBuilder.Entity("PentestHub.API.Data.Models.DomainVerification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PentestHub.API.Data.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LastLabSolvedDate")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("PentestHub.API.Data.Models.UserBadge", b =>
                {
            ...
            modelBuilder.Entity("PentestHub.API.Data.Models.UserBadge", b =>
                {
                    b.HasOne("PentestHub.API.Data.Models.Badge", "Badge")
                        .WithMany()
